    ...
    init: function () {
        !(function () {
            ...
            if (e) {
                ...
                i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-success"), t.lineWidth, 0.4);
            }
        })();
    },
};
    ...
    init: function () {
        !(function () {
            ...
            if (e) {
                ...
                i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-danger"), t.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 0.4);
            }
        })();
    },
};
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            l.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")) }),
                                l.mapPolygons.template.states.create("hover", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) }),
                                l.mapPolygons.template.states.create("active", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) });
                            ...
                            r.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0 }),
                                am5.ColorSet.new(t, {}),
                                r.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))),
                    ...
                    i = {
                        ...
                        plotOptions: {
                            radialBar: {
                                ...
                                track: { background: KTUtil.getCssVariableValue("--bs-primary-light"), strokeWidth: "100%" },
                            },
                        },
                        colors: [o],
            ...
            if (l && (!0 !== e.rendered || !l.classList.contains("initialized"))) {
                var r = parseInt(KTUtil.css(l, "height")),
                    ...
                    i = {
                        ...
                        chart: { fontFamily: "inherit", height: r, type: "radialBar", sparkline: { enabled: !0 } },
                        plotOptions: {
                            radialBar: { hollow: { margin: 0, size: "45%" }, dataLabels: { showOn: "always", name: { show: !1 }, value: { show: !1 } }, track: { background: KTUtil.getCssVariableValue("--bs-white"), strokeWidth: "100%" } },
                        },
                        colors: [o],
                        stroke: { lineCap: "round" },
                        labels: ["Progress"],
        ...
        v = function (e, t, a, l, r) {
            ...
            if (o) {
                var i = parseInt(KTUtil.css(o, "height")),
                    ...
                    n = (KTUtil.getCssVariableValue("--bs-gray-800"), KTUtil.getCssVariableValue("--bs-gray-300")),
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            r.createAxisRange(s),
                                s.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), strokeOpacity: 0.5, strokeDasharray: [3] }),
                                s.get("axisFill").setAll({ fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), fillOpacity: 0.1 }),
                            ...
                            r.createAxisRange(n),
                                n.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-danger")), strokeOpacity: 1, strokeDasharray: [3] }),
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var a = t.container.children.push(am5radar.RadarChart.new(t, { panX: !1, panY: !1, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(20), startAngle: -90, endAngle: 180 })),
                            l = [
                                { category: "Research", value: 80, full: 100, columnSettings: { fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-info")) } },
                                { category: "Marketing", value: 35, full: 100, columnSettings: { fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-danger")) } },
                                { category: "Distribution", value: 92, full: 100, columnSettings: { fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                { category: "Human Resources", value: 68, full: 100, columnSettings: { fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) } },
                            ];
                        ...
                        a = function () {
                            ...
                            var a = t.container.children.push(am5xy.XYChart.new(t, { panX: !1, panY: !1, layout: t.verticalLayout })),
                                l =
                                    (a.get("colors"),
                                    [
                                        { country: "US", visits: 725, icon: "https://www.amcharts.com/wp-content/uploads/flags/united-states.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "UK", visits: 625, icon: "https://www.amcharts.com/wp-content/uploads/flags/united-kingdom.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "China", visits: 602, icon: "https://www.amcharts.com/wp-content/uploads/flags/china.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "Japan", visits: 509, icon: "https://www.amcharts.com/wp-content/uploads/flags/japan.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "Germany", visits: 322, icon: "https://www.amcharts.com/wp-content/uploads/flags/germany.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "France", visits: 214, icon: "https://www.amcharts.com/wp-content/uploads/flags/france.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "India", visits: 204, icon: "https://www.amcharts.com/wp-content/uploads/flags/india.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "Spain", visits: 200, icon: "https://www.amcharts.com/wp-content/uploads/flags/spain.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "Italy", visits: 165, icon: "https://www.amcharts.com/wp-content/uploads/flags/italy.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "Russia", visits: 152, icon: "https://www.amcharts.com/wp-content/uploads/flags/russia.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "Norway", visits: 125, icon: "https://www.amcharts.com/wp-content/uploads/flags/norway.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                        { country: "Canada", visits: 99, icon: "https://www.amcharts.com/wp-content/uploads/flags/canada.svg", columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                    ]),
                                r = a.xAxes.push(
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            r.get("renderer").labels.template.setAll({ paddingTop: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                                r.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }),
                                r.data.setAll(l);
                            var o = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));
                            o.get("renderer").labels.template.setAll({ paddingLeft: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                                o.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] });
                            var i = am5xy.AxisRendererY.new(t, { opposite: !0 }),
                                s = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: i, min: 0, max: 100, strictMinMax: !0 }));
                            s.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), i.grid.template.set("forceHidden", !0), s.set("numberFormat", "#'%");
                            ...
                            var d = a.series.push(am5xy.LineSeries.new(t, { xAxis: r, yAxis: s, valueYField: "pareto", categoryXField: "country", stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")), maskBullets: !1 }));
                            d.bullets.push(function () {
                                return am5.Bullet.new(t, { locationY: 1, sprite: am5.Circle.new(t, { radius: 5, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")) }) });
                            }),
                                n.data.setAll(l),
                                d.data.setAll(l),
                                n.appear(),
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            a.labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                    ...
                    if (t) {
                        var a = function () {
                            ...
                            var a = e.container.children.push(am5radar.RadarChart.new(e, { panX: !1, panY: !1, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(20), startAngle: -90, endAngle: 180 })),
                                l = [
                                    { category: "Research", value: 40, full: 100, columnSettings: { fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-info")) } },
                                    { category: "Marketing", value: 50, full: 100, columnSettings: { fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-danger")) } },
                                    { category: "Distribution", value: 80, full: 100, columnSettings: { fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                    { category: "Human Resources", value: 70, full: 100, columnSettings: { fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) } },
                                ];
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            var a = t.container.children.push(am5xy.XYChart.new(t, { panX: !1, panY: !1, layout: t.verticalLayout })),
                                l = [
                                    { year: "2016", income: 23.5, expenses: 21.1, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                    { year: "2017", income: 26.2, expenses: 30.5, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                    { year: "2018", income: 30.1, expenses: 34.9, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                    { year: "2019", income: 29.5, expenses: 31.1, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                    { year: "2020", income: 30.6, expenses: 28.2, strokeSettings: { strokeWidth: 3, strokeDasharray: [5, 5] }, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                    { year: "2021", income: 40.6, expenses: 28.2, strokeSettings: { strokeWidth: 3, strokeDasharray: [5, 5] }, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                    { year: "2022", income: 34.1, expenses: 32.9, strokeSettings: { strokeWidth: 3, strokeDasharray: [5, 5] }, columnSettings: { fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) } },
                                ],
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            s.get("renderer").labels.template.setAll({ paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                                s.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }),
                                s.data.setAll(a);
                            var n = i.yAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "age", renderer: am5xy.AxisRendererY.new(t, { opposite: !0 }) }));
                            n.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }),
                                n.get("renderer").labels.template.setAll({ paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                                n.data.setAll(a);
                            ...
                            d.get("renderer").labels.template.setAll({ paddingTop: 20, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                                d.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 });
                            var m = i.series.push(
                                am5xy.ColumnSeries.new(t, { name: "Males", xAxis: d, yAxis: s, valueXField: "malePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--bs-success")), clustered: !1 })
                            );
                            m.columns.template.setAll({ tooltipText: "Males, age {categoryY}: {male} ({malePercent.formatNumber('#.0s')}%)", tooltipX: am5.p100, cornerRadiusBR: 4, cornerRadiusTR: 4, cornerRadiusBL: 0, cornerRadiusTL: 0 }),
                                m.data.setAll(a);
                            var c = i.series.push(
                                am5xy.ColumnSeries.new(t, { name: "Males", xAxis: d, yAxis: s, valueXField: "femalePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), clustered: !1 })
                            );
                            ...
                            var f,
                                u = g.children.push(am5.Label.new(t, { text: "United States", fontSize: 14, fontWeight: "500", fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800")), y: 20, x: am5.p50, centerX: am5.p50 })),
                                h = g.series.push(am5map.MapPolygonSeries.new(t, { fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), geoJSON: am5geodata_usaLow }));
                            h.mapPolygons.template.setAll({ tooltipText: "{name}", interactive: !0 }),
                                h.mapPolygons.template.states.create("hover", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) }),
                                h.mapPolygons.template.states.create("active", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) }),
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            l.labels.template.setAll({ textType: "radial", radius: 10, paddingTop: 0, paddingBottom: 0, centerY: am5.p50, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-700")) }),
                                l.grid.template.setAll({ location: 0.5, strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--bs-gray-400") });
                            ...
                            o.labels.template.setAll({ fontWeight: "500", fontSize: 12, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-700")) });
                            var i = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: o }));
                            o.grid.template.setAll({ strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--bs-gray-400") });
                            var s = a.series.push(am5radar.RadarLineSeries.new(t, { name: "Revenue", xAxis: r, yAxis: i, valueYField: "value1", categoryXField: "name", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) }));
                            s.strokes.template.setAll({ strokeOpacity: 0 }), s.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5 });
                            var n = a.series.push(
                            ...
                            n.strokes.template.setAll({ strokeOpacity: 0 }), n.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5 });
                            var d = a.radarContainer.children.push(am5.Legend.new(t, { width: 150, centerX: am5.p50, centerY: am5.p50 }));
                            d.data.setAll([s, n]), d.labels.template.setAll({ fontWeight: "600", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-700")) });
                            var m = [
                ...
                if (e) {
                    var t,
                        ...
                        l = function () {
                            ...
                            l.labels.template.setAll({ textType: "radial", radius: 10, paddingTop: 0, paddingBottom: 0, centerY: am5.p50, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800")) }),
                                l.grid.template.setAll({ location: 0.5, strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--bs-gray-400") });
                            ...
                            o.grid.template.setAll({ strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--bs-gray-400") });
                            var s = t.series.push(am5radar.RadarLineSeries.new(a, { name: "Revenue", xAxis: r, yAxis: i, valueYField: "value1", categoryXField: "name", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")) }));
                            s.strokes.template.setAll({ strokeOpacity: 0 }), s.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5 });
                            var n = t.series.push(
            ...
            if (o) {
                var i = parseInt(KTUtil.css(o, "height")),
                    ...
                    d = {
                        ...
                        yaxis: { labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" } } },
                        fill: { opacity: 1 },
                        states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } },
                        tooltip: { style: { fontSize: "12px" } },
                        colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")],
    ...
    return {
        init: function () {
            ...
            var u = [3e3, 2100, 3300, 3100, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400, 3e3, 2400, 2800],
                h = ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022"];
                    ...
                    var t,
                        a = function () {
                            if ((t = am5.Root.new(e))) {
                                ...
                                l.labels.template.setAll({ radius: 10 }), l.grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-700")) });
                                var r = am5radar.AxisRendererRadial.new(t, { minGridDistance: 20 });
                                r.grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-700")) });
                                ...
                                l.labels.template.setAll({ fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800")) }),
                                    r.labels.template.setAll({ fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800")) });
            ...
            if (t) {
                var a = t.getAttribute("data-kt-chart-color"),
                    ...
                    n = {
                        ...
                        legend: { show: !1 },
                        dataLabels: { enabled: !1 },
                        fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: 0.3, opacityTo: 0.2, stops: [15, 120, 100] } },
                        stroke: { curve: "smooth", show: !0, width: 3, colors: [i] },
                        xaxis: {
...
var KTChartsWidget47 = (function () {
    var e = { self: null, rendered: !1 },
        t = function (e) {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--bs-white"),
                    r = {
                        series: [{ name: "Sales", data: [5, 5, 15, 15, 19, 16, 27, 24, 34, 25, 40, 30, 19, 17, 22, 10, 14, 14] }],
                        chart: { fontFamily: "inherit", type: "area", height: a, toolbar: { show: !1 } },
                        legend: { show: !1 },
                        dataLabels: { enabled: !1 },
                        fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: 0.5, opacityTo: 0, stops: [0, 80, 100] } },
                        stroke: { curve: "smooth", show: !0, width: 2, colors: [l] },
                        xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 }, crosshairs: { position: "front", stroke: { color: l, width: 1, dashArray: 3 } }, tooltip: { enabled: !1 } },
                        yaxis: { labels: { show: !1 } },
                        states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } },
                        tooltip: { enabled: !1 },
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    r = {
                        ...
                        legend: { show: !1 },
                        dataLabels: { enabled: !1 },
                        fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: 0.5, opacityTo: 0, stops: [0, 120, 50] } },
                        stroke: { curve: "smooth", show: !0, width: 2, colors: [l] },
                        xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 }, crosshairs: { position: "front", stroke: { color: l, width: 1, dashArray: 3 } }, tooltip: { enabled: !1 } },
                        yaxis: { labels: { show: !1 } },
                        states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } },
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")),
                ...
                r = {
                    ...
                    dataLabels: { enabled: !1 },
                    stroke: { show: !0, width: 2, colors: ["transparent"] },
                    xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-700"), fontSize: "12px" } } },
                ...
                var i = parseInt(KTUtil.css(o, "height")),
                    ...
                    n = {
                        ...
                        xaxis: {
                            ...
                            labels: { show: !0, trim: !0, style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" } },
                        },
                        yaxis: { tickAmount: 7, min: 0, max: 700, labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" } } },
                        tooltip: {
                            style: { fontSize: "12px" },
                            x: {
                                formatter: function (e) {
                        ...
                        crosshairs: { show: !0, position: "front", stroke: { color: KTUtil.getCssVariableValue("--bs-border-dashed-color"), width: 1, dashArray: 0 } },
                        colors: [
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                    ...
                    s = {
                        ...
                        colors: [o, i],
                        grid: { borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                        markers: { colors: [o, i], strokeColor: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-gray-300")], strokeWidth: 3 },
                    };
                (e.self = new ApexCharts(t, s)),
                    setTimeout(function () {
                        e.self.render(), (e.rendered = !0);
