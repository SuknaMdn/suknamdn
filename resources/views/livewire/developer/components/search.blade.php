                    ...
                    <div class="scroll-y mh-200px mh-lg-350px">
                        ...
                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <img src="{{ asset('developer/media/svg/avatars/001-boy.svg') }}" alt="" />
                            </div>
                        ...
                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    <img class="w-20px h-20px" src="{{ asset('developer/media/svg/brand-logos/volicity-9.svg') }}" alt="" />
                                </span>
                            </div>
                        ...
                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    <img class="w-20px h-20px" src="{{ asset('developer/media/svg/brand-logos/tvit.svg') }}" alt="" />
                                </span>
                            </div>
                        ...
                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    <img class="w-20px h-20px" src="{{ asset('developer/media/svg/misc/infography.svg') }}" alt="" />
                                </span>
                            </div>
                        ...
                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    <img class="w-20px h-20px" src="{{ asset('developer/media/svg/brand-logos/leaf.svg') }}" alt="" />
                                </span>
                            </div>
                        ...
                        <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    <img class="w-20px h-20px" src="{{ asset('developer/media/svg/brand-logos/tower.svg') }}" alt="" />
                                </span>
                            </div>
